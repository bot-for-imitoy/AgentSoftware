...
public class WriteNote extends Tool {
    ...
    public Map<String, Object> getSchema() {
        ...
        schema.put("reminder_tick", "(Optional, default to no reminder. ) Reminder Tick within today's shift: tick 0 = 08:00:00, the max tick is the shift end 18:00:00 (36000 at the default 1 tick = 1 second).");
